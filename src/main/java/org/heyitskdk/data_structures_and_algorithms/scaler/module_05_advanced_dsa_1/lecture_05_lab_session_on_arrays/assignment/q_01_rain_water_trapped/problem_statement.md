...
Imagine a histogram where the bars' heights are given by the array `A`. <br>
Each bar is of uniform width, which is **1 unit**. When it rains, water will accumulate
in the valleys between the bars.
...
<img src="images/rain_1.png" height="250">
